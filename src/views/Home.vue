  ...
  <div class="home">
    ...
    <div class="updates">
      <div class="container">
        ...
        <router-link class="router-btn" to="#">Register to Learn w/ Liam <Arrow class="arrow arrow-light"/></router-link>
      </div>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      welcomeScreen: {
        title: "Welcome!",
        blogPost:
            "Weekly uploads from front to backend. Register today to never miss a post!",
        welcomeScreen: true,
        photo: "coding",
      },
      sampleBlogPost: [
